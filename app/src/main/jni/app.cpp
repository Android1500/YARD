//
// Created by Developer on 7/22/2022.
//
...
jint JNI_OnLoad(JavaVM *jvm, void *) {
    ...
    if ((clazz = env->FindClass("com/android1500/yard/CheckForRoot")) == nullptr) {
        return JNI_ERR;
    }

    JNINativeMethod methods[] = {{"getXposedStat", "()I", reinterpret_cast<void *>(getXposedStat)}};
